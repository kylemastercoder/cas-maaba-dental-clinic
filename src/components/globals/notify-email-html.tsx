import {
  ...
  export const NotifyEmail = ({
    ...
    return (
      <Html>
        <Head />
        <Preview>Follow-up Appointment Reminder - Cas-Maaba Dental Clinic</Preview>
        <Body style={main}>
          <Container style={container}>
            ...
            <Section style={informationTable}>
              ...
              <Text style={informationTableValue}>
                We hope this email finds you well. This is a reminder for your follow-up appointment at Cas-Maaba Dental Clinic. Below are the details:
              </Text>
            </Section>
            ...
            <Section style={informationTable}>
              ...
              <Row>
                <Column>
                  <Text style={informationTableLabel}>Appointment Description:</Text>
              ...
              <Row>
                <Column>
                  ...
                  <Text style={informationTableValue}>123 Dental St, Cas-Maaba</Text>
                </Column>
              </Row>
            </Section>
